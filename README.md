...
Télécharger les fichiers du laboratoire :
...
Rechercher Deploy a custom template

Sélectionner Créer votre propre modèle dans l’éditeur
...
⚠️ Application Gateway nécessite un sous-réseau dédié (/27 minimum).
